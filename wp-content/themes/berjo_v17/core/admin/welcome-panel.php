	...
	(function($) {
		$(document).ready(function() {
				$("body").on('click', '#vlog_welcome_box_hide',function(e){
	    			...
	    			$.post('<?php echo esc_url($vlog_ajax_url); ?>', {action: 'vlog_hide_welcome'}, function(response) {});
    			});
		});
	})(jQuery);
...
<div id="welcome-panel" class="welcome-panel vlog-welcome-panel">
	...
	<div class="welcome-panel-content">
		...
		<h2>Thank you for choosing Vlog!</h2>
		...
		<div class="welcome-panel-column-container">
			...
			<div class="welcome-panel-column">
				...
				?>
				<a class="button button-primary button-hero" href="<?php echo esc_url(admin_url('admin.php?page=vlog_options&tab='.$demo_import_tab)); ?>">Import demo</a>
			...
			<div class="welcome-panel-column welcome-panel-last">
				...
				<a class="button button-primary button-hero" href="http://mekshq.com/documentation/vlog" target="_blank">Learn more</a> <span class="vlog-customize-welcome">or <a href="<?php echo esc_url(admin_url('admin.php?page=vlog_options')); ?>">start customizing</a> now</span>.
			</div>
